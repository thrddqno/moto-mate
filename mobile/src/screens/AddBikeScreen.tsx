...
export default function AddBikeScreen({ navigation }: any) {
  ...
  const handleSave = async () => {
    ...
    setErrors({});
    try {
      await api.post<ApiResponse<any>>('/motorcycles', {
        name: name.trim(),
        make: make.trim() || null,
      ...
      if (data?.errors && Array.isArray(data.errors)) {
        ...
        Alert.alert('Error', data?.message || 'Failed to save motorcycle');
      }
    } finally {
      setSaving(false);
    }
